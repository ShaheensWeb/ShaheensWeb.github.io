    ...
    return ( 
        <div className="hero">
            ...
            <div className="content-wrapper">
                ...
                <h2 className="hero-subheading">A Solana NFT project fully built by the community. Stake your LoS NFT for $GLD and play in the LoS turned based game to take control over Esnen.</h2>
